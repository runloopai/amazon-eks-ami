...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1alpha1.CredentialProvider)(nil), (*api.CredentialProvider)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_CredentialProvider_To_api_CredentialProvider(a.(*v1alpha1.CredentialProvider), b.(*api.CredentialProvider), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.CredentialProvider)(nil), (*v1alpha1.CredentialProvider)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_CredentialProvider_To_v1alpha1_CredentialProvider(a.(*api.CredentialProvider), b.(*v1alpha1.CredentialProvider), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_CredentialProvider_To_api_CredentialProvider(in *v1alpha1.CredentialProvider, out *api.CredentialProvider, s conversion.Scope) error {
	out.Name = in.Name
	out.MatchImages = *(*[]string)(unsafe.Pointer(&in.MatchImages))
	out.DefaultCacheDuration = in.DefaultCacheDuration
	return nil
}

// Convert_v1alpha1_CredentialProvider_To_api_CredentialProvider is an autogenerated conversion function.
func Convert_v1alpha1_CredentialProvider_To_api_CredentialProvider(in *v1alpha1.CredentialProvider, out *api.CredentialProvider, s conversion.Scope) error {
	return autoConvert_v1alpha1_CredentialProvider_To_api_CredentialProvider(in, out, s)
}

func autoConvert_api_CredentialProvider_To_v1alpha1_CredentialProvider(in *api.CredentialProvider, out *v1alpha1.CredentialProvider, s conversion.Scope) error {
	out.Name = in.Name
	out.MatchImages = *(*[]string)(unsafe.Pointer(&in.MatchImages))
	out.DefaultCacheDuration = in.DefaultCacheDuration
	return nil
...
// Convert_api_CredentialProvider_To_v1alpha1_CredentialProvider is an autogenerated conversion function.
func Convert_api_CredentialProvider_To_v1alpha1_CredentialProvider(in *api.CredentialProvider, out *v1alpha1.CredentialProvider, s conversion.Scope) error {
	return autoConvert_api_CredentialProvider_To_v1alpha1_CredentialProvider(in, out, s)
}
...
func autoConvert_v1alpha1_KubeletOptions_To_api_KubeletOptions(in *v1alpha1.KubeletOptions, out *api.KubeletOptions, s conversion.Scope) error {
	...
	out.CredentialProviders = *(*[]api.CredentialProvider)(unsafe.Pointer(&in.CredentialProviders))
...
func autoConvert_api_KubeletOptions_To_v1alpha1_KubeletOptions(in *api.KubeletOptions, out *v1alpha1.KubeletOptions, s conversion.Scope) error {
	...
	out.CredentialProviders = *(*[]v1alpha1.CredentialProvider)(unsafe.Pointer(&in.CredentialProviders))
